...
- product_category = ГЛАВНОЕ существительное именной группы (что это за предмет по сути).
- search_modifiers = ВСЕ зависимые слова при этом существительном: согласованные прилагательные и причастия (настольная, напольная, потолочная, уличная, накладная, встраиваемая, подвесная, светодиодная, садовый, кухонный, силовой и т.п.), предложные группы ("с заземлением", "для ванной", "на 16 ампер"), числительные и параметры.
- НИКОГДА не склеивай прилагательное+существительное в одну category. "настольная лампа" — это лампа (категория) с признаком "настольная" (модификатор), а НЕ category="настольная лампа".
- Исключение: устойчивый составной термин, который сам по себе является типом товара и без второго слова теряет смысл (например "автоматический выключатель" → category="автоматический выключатель", потому что просто "выключатель" — это другой класс товаров). В сомнительных случаях предпочитай разделение: одиночное существительное в category, прилагательное в modifiers.
