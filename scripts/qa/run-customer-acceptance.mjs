...
export function parseSse(body) {
  ...
  return { text, textBeforeProducts, productsMarkdown, links, logId, completed, serverProductsCount, diagnosticError, conversationBoundary, selectionContract, toolEvents };
}
