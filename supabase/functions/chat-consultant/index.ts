...
📚 СЛОВАРЬ СИНОНИМОВ (разговорный термин → технический):
ВСЕГДА переводи разговорные/бытовые термины в технические!

Электроустановочные изделия:
- "слот", "гнездо", "пост", "ячейка" → "место" (рамка на 2 слота = рамка 2-местная)
- "дырка", "отверстие", "выход" → "место" или "пост"
- "тройник" → "колодка", "удлинитель", "разветвитель"
- "переходник" → "адаптер", "вилка"

Размеры и количество:
- "одинарный", "один" → "1-местная", "одноместная"
- "двойной", "два", "на 2" → "2-местная", "двухместная"
- "тройной", "три", "на 3" → "3-местная", "трёхместная"
- "на 4", "четырёхместный" → "4-местная"

Инструменты:
- "болгарка" → "УШМ", "угловая шлифмашина"
- "дрель-шуруповёрт" → "шуруповёрт", "дрель аккумуляторная"
- "перфоратор" → "SDS", "бур"
- "лобзик" → "электролобзик"

Кабель и провод:
- "провод" → "кабель", "ВВГ", "ПВС"
- "трёхжильный" → "3x", "3х" (например "кабель 3x2.5")

Для intent="catalog" или "brands":
- ПЕРВЫЙ кандидат = ОДНО главное слово товара В ТЕХНИЧЕСКОМ ТЕРМИНЕ!
- Остальные 2-4 кандидата = вариации с синонимами и техническими терминами
- ПЕРЕВОДИ разговорные термины в технические!
- КОРОТКИЕ запросы работают лучше! API плохо ищет длинные фразы с 3+ словами

Примеры правильных кандидатов:
- "рамка для розетки на 2 слота" → ["рамка 2-местная", "рамка двухместная", "рамка 2 поста"]
- "розетка накладная с заземлением" → ["розетка", "розетка накладная", "розетка заземление"]
- "автоматический выключатель ABB" → ["автомат", "автоматический выключатель", "выключатель ABB"]
- "шуруповёрт аккумуляторный Makita" → ["шуруповёрт", "шуруповёрт Makita", "дрель-шуруповёрт"]
- "болгарка Бош" → ["УШМ Bosch", "болгарка Bosch", "угловая шлифмашина"]

❌ НЕПРАВИЛЬНО: "рамка для розетки на 2 слота" → ["рамка розетка слот"] — слово "слот" НЕ техническое!
✅ ПРАВИЛЬНО: ["рамка 2-местная", "рамка двухместная"] — переведено в технические термины!
