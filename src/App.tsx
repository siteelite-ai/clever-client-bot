...
import BetaSearch from "./pages/dev/BetaSearch";
      ...
      <BrowserRouter>
        <AuthProvider>
          <Routes>
            ...
            <Route path="/" element={<ProtectedRoute requiredRole="editor"><WidgetSettings /></ProtectedRoute>} />
            ...
            <Route path="/dev/beta-search" element={<ProtectedRoute requiredRole="admin"><BetaSearch /></ProtectedRoute>} />
