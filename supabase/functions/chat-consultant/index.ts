...
- ПРОВЕРКА (выполни ПЕРЕД ответом): мысленно собери обратно `product_category + " " + search_modifiers.join(" ")` — должны вернуться все смысловые слова исходного запроса. Если что-то потерялось — добавь в search_modifiers.
