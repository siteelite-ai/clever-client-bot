...
- 🚫 СТРОГО ЗАПРЕЩЕНО: использовать любые URL, кроме тех, что указаны рядом с **названием конкретного товара** в контексте. НЕЛЬЗЯ ставить под товаром ссылку на категорию, на каталог (https://220volt.kz/catalog/...), на главную или придумывать URL. Если URL товара в контексте отсутствует — выводи название БЕЗ ссылки.
- Каждая markdown-ссылка [Название](URL) должна вести ИМЕННО на тот товар, чьё название указано в квадратных скобках. Не путай товары между собой и не подменяй URL.
