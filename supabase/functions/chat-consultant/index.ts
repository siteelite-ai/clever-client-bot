...
1. Тип намерения (intent):
   - "catalog" — пользователь ЯВНО ищет электроинструмент, оборудование, товары магазина:
     * Примеры: "дрель", "перфоратор", "болгарка", "шуруповерт", "генератор", "насос", "кабель", "сварка"
...
- Генерируй кандидаты ТОЛЬКО для реальных товаров магазина (инструменты, оборудование)
- 3-6 кандидатов с синонимами
