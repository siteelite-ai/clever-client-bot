 ...
 *
 * Источник: согласовано с пользователем 2026-04-29 — «50» как баланс между
 * покрытием Self-Bootstrap-словаря (§4.10.1) и latency. Тест на N=5 показал
 * достаточность для частых атрибутов (полюсы, разъёмы), но недостаточность
 * для перечислимых множеств с высокой кардинальностью (Цвет).
 *
