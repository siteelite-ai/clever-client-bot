...
- ПЕРВЫЙ кандидат = ОДНО главное слово товара (без уточнений!): "розетка", "дрель", "автомат"
- Остальные 2-4 кандидата = вариации с синонимами и уточнениями
...
- "автоматический выключатель ABB" → ["автомат", "автоматический выключатель", "выключатель автоматический"]
- "шуруповёрт аккумуляторный Makita" → ["шуруповёрт", "шуруповёрт Makita", "дрель-шуруповёрт"]

❌ НЕПРАВИЛЬНО: "розетка накладная с заземлением IP44" — слишком длинно!
✅ ПРАВИЛЬНО: "розетка" — всегда должен быть первым!
